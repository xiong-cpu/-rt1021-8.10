...
void pwm_iomuxc(PWMCH_enum pwmch)
{
    switch(pwmch)
    {
        ...
        case PWM1_MODULE3_CHA_B28:  iomuxc_pinconf(B28,ALT1,PWM_PIN_CONF); break;
        case PWM1_MODULE3_CHA_C20:  iomuxc_pinconf(C20,ALT1,PWM_PIN_CONF); break;
        
        case PWM1_MODULE3_CHB_B29:  iomuxc_pinconf(B29,ALT1,PWM_PIN_CONF); break;
        case PWM1_MODULE3_CHB_C21:  iomuxc_pinconf(C21,ALT1,PWM_PIN_CONF); break;
        
        
        
        case PWM2_MODULE0_CHA_B14:  iomuxc_pinconf(B14,ALT1,PWM_PIN_CONF); break;
        case PWM2_MODULE0_CHA_D6 :  iomuxc_pinconf(D6 ,ALT1,PWM_PIN_CONF); break;
        
        case PWM2_MODULE0_CHB_B15:  iomuxc_pinconf(B15,ALT1,PWM_PIN_CONF); break;
        case PWM2_MODULE0_CHB_D7 :  iomuxc_pinconf(D7 ,ALT1,PWM_PIN_CONF); break;
        
        case PWM2_MODULE1_CHA_B12:  iomuxc_pinconf(B12,ALT1,PWM_PIN_CONF); break;
        case PWM2_MODULE1_CHA_D4 :  iomuxc_pinconf(D4 ,ALT1,PWM_PIN_CONF); break;
        
        case PWM2_MODULE1_CHB_B13:  iomuxc_pinconf(B13,ALT1,PWM_PIN_CONF); break;
        case PWM2_MODULE1_CHB_D5 :  iomuxc_pinconf(D5 ,ALT1,PWM_PIN_CONF); break;
        
        case PWM2_MODULE2_CHA_B10:  iomuxc_pinconf(B10,ALT1,PWM_PIN_CONF); break;
        case PWM2_MODULE2_CHA_C30:  iomuxc_pinconf(C30,ALT1,PWM_PIN_CONF); break;
        
        case PWM2_MODULE2_CHB_B11:  iomuxc_pinconf(B11,ALT1,PWM_PIN_CONF); break;
        case PWM2_MODULE2_CHB_C31:  iomuxc_pinconf(C31,ALT1,PWM_PIN_CONF); break;
        
        case PWM2_MODULE3_CHA_B6 :  iomuxc_pinconf(B6 ,ALT1,PWM_PIN_CONF); break;
        case PWM2_MODULE3_CHA_C28:  iomuxc_pinconf(C28,ALT1,PWM_PIN_CONF); break;
        
        case PWM2_MODULE3_CHB_B7 :  iomuxc_pinconf(B7 ,ALT1,PWM_PIN_CONF); break;
